...
public class DemoActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path = getIntent().getStringExtra("com.example.ikent.Path");
    ...
    protected List<Map<String, Object>> getData(String prefix) {
        ...
        mainIntent.addCategory("com.example.ikent.SIMPLE_CODE");
    ...
    protected Intent browseIntent(String path) {
        ...
        result.putExtra("com.example.ikent.Path", path);
        return result;
    }
